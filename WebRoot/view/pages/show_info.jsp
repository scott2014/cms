...
<table cellspacing="0" cellpadding="0" bgcolor="#1C80B7" width="98%"
			...
			<tbody>
				<tr bgcolor="#FFFFFF">
					<td width="25%">头像：</td>
					<td align="left">
						<img src="<%=basePath %>/<s:property value='user.photo'/>"/>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td>用户名：</td>
				...
				<tr bgcolor="#FFFFFF">
					<td> 单位(大学)：</td>
					<td align="left">
						<s:property value='user.university'/>
        			</td>
				</tr>
				...
				<tr bgcolor="#FFFFFF">
					<td>注册日期：</td>
					<td align="left">
						<s:date name='user.registerTime' format="yyyy-MM-dd HH:mm"/>
        			</td>
				</tr>
				...
				<tr bgcolor="#FFFFFF">
					<td>最后一次登录日期：</td>
					<td align="left">
						<s:date name='user.lastLogin' format="yyyy-MM-dd HH:mm"/>
        			</td>
				</tr>
